            ...
            <?php 
                ...
                if($ketemu){
                    while($data=mysqli_fetch_array($res)){ ?>
                        <form method="POST" action="proses_hapus_jampel.php" name="fhapus">
                            <div class="table-responsive">
                                ...
                                <?php 
                                    echo "<input type='hidden' name='id' value='$data[id_jampel]' required>";
                                    echo "<input type='hidden' name='nama' value='$data[jampel]' required>"; 
                                ?>
                                <hr><center><input type='submit' class="btn btn-primary" name='btn_submit' value='Hapus'>
                                    <a class="btn btn-secondary" href='data_jampel.php'>Cancel</a> </center>
                            </div>
                        </form>
                    <?php
                    }
