                        ...
                        <form method="POST" action="proses_edit_siswa.php" name="fedit" onsubmit="return validasi()">
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    <tr><th>Kelas</th> <td><?php echo "<input type ='text' name='kelas' maxlength='4' value='$data[kelas]' required autocomplete='off'>"; ?></td></tr>
                                    <tr><th>Tanggal Lahir</th> <td><?php echo "<input type ='date' name='tgl_lahir' value='$data[tgl_lahir]' required autocomplete='off'>"; ?></td></tr>
                                    <tr><th>Agama</th> <td><?php echo "<input type ='text' name='agama' value='$data[agama]' required autocomplete='off'>"; ?></td></tr>
                                </thead>
                                </table>
