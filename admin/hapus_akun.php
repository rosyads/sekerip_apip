    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Hapus Data Akun</h1>
            ...
            <?php 
                ...
                if($ketemu){
                    while($data=mysqli_fetch_array($res)){ ?>
                        <form method="POST" action="proses_hapus_akun.php" name="fhapus">
                            <div class="table-responsive">
                                ...
                                <?php 
                                    echo "<input type='hidden' name='id' value='$data[id_akun]' required>";
                                    echo "<input type='hidden' name='username' value='$data[username]' required>"; 
                                ?>
