            ...
            <?php 
                ...
                if($ketemu){
                    while($data=mysqli_fetch_array($res)){ ?>
                        <form method="POST" action="proses_edit_kelas.php" name="fedit"">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" width="50%" cellspacing="0">
                                <thead>
                                    <?php echo "<input type ='hidden' name='id' value='$data[id_kelas]' required>"; ?>
                                    <tr><th>Nama Kelas</th> <td><?php echo "<input type ='text' name='nama' maxlength='4' value='$data[nama_kelas]' required autocomplete='off'>"; ?></td></tr>
                                </thead>
                                </table>
